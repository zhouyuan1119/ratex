 ...
 * consumption in MBs. 
 * \param tensors List of tensors in the program
 * \param nodes List of operators in the program, sorted in topological order 
 * \param params List of pointers to parameter information
 * \param use_cnts Use count of each node, generated by AnalyzeUseCount()
 * \param param_tensor_ids Set of parameter tensor IDs, generated by GetParameterTensorIds()
 * \param node_tensor_map Mapping from IR Node* to output tensor IDs, generated by GetNodeTensorIdMap()
 */
